function [nnRawData, hmean, segLengths] = j2nnRawHJ_absH(d, par)
% transform mocap structure d to nn raw data. this version codes root
% height in absolute height above ground
%
...
nnRawData = [hraw forwardAngDiffs xyDiffsRelative segUnitVecs];
