function p = mcanimateHJ(d, p, proj, xRootShifts, yRootShifts)
...
p = mcplotframeHJ1(d,1:d.nFrames,p, proj, xRootShifts, yRootShifts); % output parameter added 240608
