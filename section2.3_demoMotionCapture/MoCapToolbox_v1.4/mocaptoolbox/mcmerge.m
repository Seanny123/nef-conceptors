...
% The following animation parameters: scrsize, limits, az, el, msize, trl, showfnum, animate, fps, folder, and pers
% will be used as set in p1. The other parameters will be merged and returned.
%
% see also
% mcconcatenate
%
