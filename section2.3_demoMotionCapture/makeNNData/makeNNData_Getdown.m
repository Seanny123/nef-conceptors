...
[nnRawDataGetdown, hmeanGetdown, segLengthsGetdown] = ...
    j2nnRawHJ_absH(dj,j2spar);

%% backtransform to joint data for test and show video
if 0
freq = 120; 
djBack =  nnRaw2jHJ_absH(nnRawDataGetdown, hmeanGetdown, ...
     segLengthsGetdown, j2spar, freq);
...
if 0
    figure(1); clf;
    plot(nnRawDataGetdown(:,10:12));
end
refsig = nnRawDataGetdown(:,12);
...
if 1
    plGetdown = plOpt1;
    save nnRawGetdown nnRawDataGetdown hmeanGetdown ...
        plGetdown segLengthsGetdown;
end
