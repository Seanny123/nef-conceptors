...
[nnRawDataGetSeated, hmeanGetSeated, segLengthsGetSeated] = ...
    j2nnRawHJ_absH(dj,j2spar);

%% backtransform to joint data for test and show video
if 0
freq = 120; 
djBack =  nnRaw2jHJ_absH(nnRawDataGetSeated, hmeanGetSeated, ...
     segLengthsGetSeated, j2spar, freq);
...
if 1
    save nnRawGetSeated nnRawDataGetSeated hmeanGetSeated ...
         segLengthsGetSeated;
end
