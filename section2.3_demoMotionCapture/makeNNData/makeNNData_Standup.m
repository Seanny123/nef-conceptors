...
[nnRawDataStandup, hmeanStandup, segLengthsStandup] = ...
    j2nnRawHJ_absH(dj,j2spar);

%% backtransform to joint data for test and show video
if 0
freq = 120; 
djBack =  nnRaw2jHJ_absH(nnRawDataStandup, hmeanStandup, ...
     segLengthsStandup, j2spar, freq);
...
if 0
    figure(1); clf;
    plot(nnRawDataStandup(:,10:12));
end
refsig = nnRawDataStandup(:,12);
...
if 1
    plStandup = plOpt1;
    save nnRawStandup nnRawDataStandup hmeanStandup ...
        plStandup segLengthsStandup;
end
