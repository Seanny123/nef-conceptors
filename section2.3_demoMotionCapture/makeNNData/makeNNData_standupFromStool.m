...
[nnRawDataStandupFromStool, hmeanStandupFromStool, segLengthsStandupFromStool] = ...
    j2nnRawHJ_absH(dj,j2spar);

%% backtransform to joint data for test and show video
if 0
freq = 120; 
djBack =  nnRaw2jHJ_absH(nnRawDataStandupFromStool, hmeanStandupFromStool, ...
     segLengthsStandupFromStool, j2spar, freq);
...
if 1
    save nnRawStandupFromStool nnRawDataStandupFromStool hmeanStandupFromStool ...
         segLengthsStandupFromStool;
end
